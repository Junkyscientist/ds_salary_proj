# -*- coding: utf-8 -*-
"""
Created on Sat Sep 12 16:21:45 2020

@author:JunkysScientist
"""
import pandas as pd
...
df['employer_provided'] = df['Salary Estimate'].apply(lambda x: 1 if 'ployer provided salary' in x.lower()else 0)
